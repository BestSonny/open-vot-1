...
from lib.experiments import ExperimentSupervised
from lib.trackers import TrackerSiamFC
from lib.datasets import VOT


class TestExperimentSupervised(unittest.TestCase):
    ...
    def test_experiment_supervised(self):
        experiment = ExperimentSupervised(log_dir='results/SiamFC')
